...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
            <tr>
                <td align="center" valign="top" style="font-size:0; padding: 35px;" bgcolor="#ff7700">
                ...
                <div style="display:inline-block; max-width:50%; min-width:100px; vertical-align:top; width:100%;">
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;">
                        ...
                        <td align="left" valign="top" style="font-size: 36px; font-weight: 800; line-height: 48px;" class="mobile-center">
                               <img src="https://roomshalaimages.s3.amazonaws.com/logo_White.png" width="40" height="40" style="display: block; border-radius: 50%;border:2px solid #ffffff;padding:5px;"/>
                            </td>
                            <td align="left" valign="top" style=" font-size: 36px; font-weight: 800; line-height: 48px;" class="mobile-center">
                                <h1 style="font-size: 30px; font-weight: 800; margin: 0; color: #ffffff;">Roomshala</h1>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <td align="center" valign="top" style="font-size:0;">
                                ...
                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;">
                                    <tr>
                                        <td align="left" valign="top" style=" font-size: 16px; font-weight: 400; line-height: 24px;">
                                            <p style="font-weight: 800;">Hotel Information:</p>
                                            <p>{}<br>
                            ...
                            <div style="display:inline-block; max-width:50%; min-width:240px; vertical-align:top; width:100%;">
                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:300px;">
                                    <tr>
                                        <td align="left" valign="top" style=" font-size: 16px; font-weight: 400; line-height: 24px;">
                                            <p style="font-weight: 800;">Guest Details</p>
                                            <p>Name: {}</p>
                                            <p>Phone Number : {}</p>
                                            <p>Email Id: {}</p>
                                        </td>
